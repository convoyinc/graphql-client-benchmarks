...
export default class WriteWithHundredTwentyFiveObserversAndCompleteCache extends Benchmark {
  static metadata = {
    title: `write (125 identical observers, fully cached, identical query written)`,
  };
